...
ls /home/$1 > /dev/null 2>&1 || { echo "Usuario Inexistente" ; exit 1; } # funcao verifica se o usuario existe 

USERID=$(grep $1 /etc/passwd|cut -d":" -f3) # corta o código so usuario a partir do terceiro código.
