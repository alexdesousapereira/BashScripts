...
cat /dev/null > $FILE # verifica se existe um arquivo existente

PORC_EXIBIDA=0

# Criando estrutura de repetição insere palavras até o tamanho arquivo desejado.
...
do
	...
	# Verirfica se a porcentagem é divisivel, caso sim demonstra o tamanho atual
